    ...
    <div className=' w-full max-w-[1440px] bg-slate-800 h-full flex flex-col items-center'>
        ...
        <div className=' w-full max-w-[1040px] flex flex-col gap-2 items-center justify-center p-6'>
            ...
            <AccordionItem value="item-1">
                <AccordionTrigger className=' w-full'>What is speedtrade?</AccordionTrigger>
                <AccordionContent>
                    Speedtrade is a trading system where players buy a rig miner, enabling them to trade assets quickly and efficiently by using advanced algorithms to optimize profits in a competitive market
                </AccordionContent>
            </AccordionItem>
            </Accordion>
            ...
            <Accordion type="single" collapsible className=' w-full'>
            <AccordionItem value="item-1">
                <AccordionTrigger className=' w-full'>How can i earn money in Speedtrade?</AccordionTrigger>
                <AccordionContent>
            ...
            <AccordionItem value="item-1">
                ...
                <AccordionContent>
                   To create an account on Speedtrade, you must first join our official communities on platforms like Discord, Facebook Groups, or other social media channels indicated in the website. Once you are part of the community, reach out to any of the community leaders or admins. These individuals are designated to assist new players in getting started, and you can ask them for a referral link. After receiving the referral link, click on it to be redirected to the Speedtrade registration page. There, you will need to fill out the necessary information, including your name, email address, and other required details. Once you have completed the form, submit it to create your account and start your journey in Speedtrade.
                </AccordionContent>
            </AccordionItem>
            </Accordion>
            ...
            <Accordion type="single" collapsible className=' w-full'>
            <AccordionItem value="item-1">
                <AccordionTrigger className=' w-full'>What types of rig miner can i buy in Speedtrade?</AccordionTrigger>
                <AccordionContent>
                    Speedtrade offers a wide variety of rig miners, categorized into 3 types Quick lane, Swift Lane and Rapid lane. Each type offers different earnings based on the rig miner you purchase. The Quick Lane provides a 30% profit over a 5 days earning period, with a minimum investment of ₱500 and a maximum of ₱2,000. The Swift Lane offers an 80% profit over 10 days, with investment amounts ranging from ₱2,000 to ₱20,000. Lastly, the Rapid Lane delivers a 200% profit over a 20 days period, with a minimum investment of ₱20,000 and a maximum of ₱2,000,000.
                </AccordionContent>
            </AccordionItem>
            </Accordion>
