...
export default function Cards() {
  ...
  return (
    ...
    <Card icon={<Wallet size={30} />} iconbg={' bg-green-500'} title={'Total Miner Request'} amount={`${total?.totalrequestminecoin.toLocaleString()}`} subtitle={'User Total Miner Request'} text={''} loading={loading}/>
