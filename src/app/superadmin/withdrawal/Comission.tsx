...
export default function Comissionlist() {
  ...
  return (
    <div className=' relative w-full flex flex-col items-center gap-8 max-w-[1440px] min-h-[500px] h-auto mt-12 bg-slate-900 p-6'>
        <div className=' flex md:flex-row flex-col items-center justify-between absolute top-0 w-[98%] z-30 gap-2 h-auto md:h-[55px] bg-gradient-to-r from-green-700 to-green-500 p-2 rounded-sm -translate-y-4'>
            ...
            <div className=' flex flex-wrap items-center gap-2'>
              ...
              <input value={date} onChange={(e) => setDate(e.target.value)} type="date" className=' text-xs p-2 text-black rounded-sm' />
                ...
                <button onClick={reset} className=' p-2 bg-green-700 rounded-sm'><RefreshCcw size={15}/></button>
            </div>
