...
export default function page() {
  ...
  return (
    <div className=' w-full h-screen flex flex-col items-center p-4 py-16 bg-slate-900 overflow-y-auto'>

        <div className=' max-w-[1520px] w-full flex flex-col gap-6'>

            <div className=' relative w-full h-[150px]  bg-slate-800 flex items-center justify-between p-8 rounded-md'
            style={{backgroundImage: "url(/assets/BG.png)", backgroundPosition:'center'}}
            >

                <div className=' absolute left-0 top-0 w-full h-full bg-zinc-950/80'>
            ...
            <div className=' flex flex-wrap items-center justify-center gap-6 mt-12'>
                ...
                <Card icon={<Wallet size={30}/>} iconbg={'bg-amber-500'} title={'Total comission'} amount={`${wallet?.userwallets.commissionwallet.amount.toLocaleString()}`} subtitle={'Total withdrawables'} text={''} loading={false}/>
            ...
            <TabsList className=' w-full pl-16 md:pl-0 md:w-fit bg-slate-950 flex md:text-sm text-[5rem] overflow-x-auto'>
