            ...
            <div className=' flex flex-wrap items-center justify-center gap-2'>
              ...
              <DialogContent>
                ...
                <form action="" className=' w-full flex flex-col gap-1'>
                  ...
                  <input type="text" placeholder='Username' className=' text-sm text-black p-2 rounded-md' />

                  <label htmlFor="" className=' text-xs mt-2'>Password</label>
                  <input type="text" placeholder='Passowrd' className=' text-sm text-black p-2 rounded-md' />

                  <button className=' bg-gradient text-sm font-semibold px-8 py-2 rounded-md w-fit mt-6'>Create</button>

                </form>
              </DialogContent>
            </Dialog>

              <button className=' px-6 p-2 bg-red-600 rounded-sm text-white text-xs'>Ban</button>
