    ...
    <div className=' w-full flex items-end justify-end h-[330px] lg:h-[350px] max-w-[470px]'>
        <div className=' relative w-full flex flex-col bg-slate-800 rounded-sm p-6 h-auto'>
            ...
            <div className=' w-full flex flex-col gap-2 mt-16'>
                <p className=' text-sm text-zinc-100'>Earnings: <span className=' text-green-500'>P {(prop.earnings).toLocaleString()}</span></p>
                ...
                <div className=' w-full flex items-center justify-between mt-2'>
                    ...
                    <button className=' px-6 py-2 text-sm font-semibold text-white bg-gradient-to-r from-green-700 to-green-500 rounded-sm'>Claim</button>
